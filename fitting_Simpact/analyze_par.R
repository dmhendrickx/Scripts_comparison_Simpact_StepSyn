...
# In R-2.3.1: load ARF package and workspace_arf.RData
...
p1<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_a",y="predicted probability of low relative sum of squared errors")

d=data.frame(x=dataframe_arf$hiv_e1,y=pred1)
p2<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_e1",y="predicted probability of low relative sum of squared errors")

d=data.frame(x=dataframe_arf$hiv_e2,y=pred1)
p3<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_e2",y="predicted probability of low relative sum of squared errors")

d=data.frame(x=dataframe_arf$hiv_f1,y=pred1)
p4<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_f1",y="predicted probability of low relative sum of squared errors")

pred2<-predict.gam(gammod2,dataframe_arf,type="response")

d=data.frame(x=dataframe_arf$hiv_a,y=pred2)
p5<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_a",y="predicted probability of low relative sum of squared errors")

d=data.frame(x=dataframe_arf$hiv_e1,y=pred2)
p6<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_e1",y="predicted probability of low relative sum of squared errors")

d=data.frame(x=dataframe_arf$hiv_e2,y=pred2)
p7<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_e2",y="predicted probability of low relative sum of squared errors")

d=data.frame(x=dataframe_arf$hiv_f1,y=pred2)
p8<-ggplot(d,aes(x=x,y=y)) + geom_point(alpha=1, color="black") + geom_smooth(alpha=0) + labs(x="hiv_f1",y="predicted probability of low relative sum of squared errors")

save.image("workspace_gam.RData")

#maximal information coefficient
library(minerva)
mine(hiv_a_1pc,hiv_e1_1pc)
mine(hiv_a_1pc,hiv_e2_1pc)
mine(hiv_a_1pc,hiv_f1_1pc)

mine(hiv_e1_1pc,hiv_e2_1pc)
mine(hiv_e1_1pc,hiv_f1_1pc)

mine(hiv_e2_1pc,hiv_f1_1pc)
